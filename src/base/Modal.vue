            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close" @click="onClose"></button>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="buttton" class="btn btn-primary" @click="onConfirm">确定</button>
                    </div>
                </div>
            </div>
        </div>
